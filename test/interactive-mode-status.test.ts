...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.yue/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.yue/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.yue/extensions",
				}),
			},
			{
				path: "/tmp/project/.yue/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.yue/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.yue/extensions",
			...
			{
				path: "/tmp/project/.yue/npm/node_modules/yue-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.yue/npm/node_modules/yue-markdown-preview/extensions/index.ts", {
					source: "npm:yue-markdown-preview",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.yue/npm/node_modules/yue-markdown-preview",
				}),
			},
			{
				path: "/tmp/project/.yue/npm/node_modules/@scope/yue-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.yue/npm/node_modules/@scope/yue-scoped/extensions/index.ts", {
					source: "npm:@scope/yue-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.yue/npm/node_modules/@scope/yue-scoped",
				}),
			},
			{
				path: "/tmp/project/.yue/git/github.com/HazAT/yue-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.yue/git/github.com/HazAT/yue-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/yue-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.yue/git/github.com/HazAT/yue-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.yue/git/github.com/HazAT/yue-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.yue/git/github.com/HazAT/yue-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/yue-interactive-subagents",
						scope: "project",
						origin: "package",
	...
	test("captures mixed extension layouts in compact output", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.chatContainer)).toMatchInlineSnapshot(`
			"[Extensions]
			  @scope/yue-scoped, answer.ts, cli-extension.ts, HazAT/yue-interactive-subagents, HazAT/yue-interactive-subagents:subagents, local-index/index.ts, user-index/index.ts, yue-markdown-preview"
		`);
	});
...
"[Extensions]
  project
    /tmp/project/.yue/extensions/answer.ts
    /tmp/project/.yue/extensions/local-index/index.ts
    git:github.com/HazAT/yue-interactive-subagents
      extensions/index.ts
      extensions/subagents/index.ts
    npm:@scope/yue-scoped
      extensions/index.ts
    npm:yue-markdown-preview
      extensions/index.ts
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "yue");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [{ path: path.join(home, ".yue", "agent", "AGENTS.md") }, { path: path.join(cwd, "AGENTS.md") }],
		});
		...
		expect(output).toContain("~/.yue/agent/AGENTS.md, AGENTS.md");
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.chatContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.yue/agent/AGENTS.md");
		expect(output).toContain("~/Development/yue/AGENTS.md");
		expect(output).not.toContain("~/.yue/agent/AGENTS.md, AGENTS.md");
	});
