...
export interface ScheduledTask {
	 ...
	 *   - "main"       → stored at ~/.yue/main/scheduler/tasks.json
	 *   - "workspace"  → stored at ~/.yue/workspaces/<workspaceId>/scheduler/tasks.json
...
/** A user-invocable skill (from ~/.yue skills), as returned by get_skills. */
