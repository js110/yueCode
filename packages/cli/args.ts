...
If grep/find/ls are missing from PATH, Yue injects temporary shims only for those missing commands.
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as YUE_OFFLINE=1)
  ...
  --main-dir <path>              Override the main agent working directory (default: ~/.yue/main)
...
${chalk.bold("Environment Variables:")}
  ...
  YUE_PACKAGE_DIR                - Override package directory (for Nix/Guix store paths)
  YUE_OFFLINE                    - Disable startup network operations when set to 1/true/yes
  YUE_TELEMETRY                  - Override install telemetry when set to 1/true/yes or 0/false/no
  YUE_SHARE_VIEWER_URL           - Base URL for /share command (default: https://yue.dev/session/)
  YUE_AI_ANTIGRAVITY_VERSION     - Override Antigravity User-Agent version (e.g., 1.23.0)
