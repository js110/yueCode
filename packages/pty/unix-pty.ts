...
const logPath = process.env.YUE_PTY_LOG === "0" ? null : "/tmp/yue-pty.log";
 *
...
// Diagnostics: write to /tmp/yue-pty.log so failures in the packaged app
// (where stdout/stderr are invisible) are diagnosable. Set YUE_PTY_LOG=0 to disable.
const logPath = process.env.YUE_PTY_LOG === "0" ? null : "/tmp/yue-pty.log";
