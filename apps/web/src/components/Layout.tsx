...
const PINNED_KEY = "yue:pinned-workspaces";
const COLLAPSED_KEY = "yue:sidebar-collapsed";
...
const MAIN_CHAT_CWD = "~/.yue/main";

function isMainChatCwd(cwd: string | null | undefined): boolean {
	if (!cwd) return false;
	if (cwd === MAIN_CHAT_CWD) return true;
	// Match expanded path like /Users/tom/.yue/main
	return cwd.endsWith("/.yue/main");
}
