/**
 * Agent Types — yue's own message / tool / state model.
 *
...
// ============================================================================
// Thinking levels (Yue's extension; includes "off" which pi-ai doesn't have)
// ============================================================================

export type ThinkingLevel = "off" | AiThinkingLevel;

// ============================================================================
// Custom message types — yue-specific roles that flow alongside LLM messages
// ============================================================================
...
/** Filter yue-specific messages, keep only those the LLM can consume. */
