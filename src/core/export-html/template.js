    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="yue-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="yue-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'yue-share:v1:sidebar-width';
