...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `yue` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "yue";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown Yue and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Yue loaded without re-discovering resources. */
...
export interface ExtensionAPI {
	 ...
	 * yue.registerProvider("anthropic", {
	 *   baseUrl: "https://proxy.example.com"
	 * });
	 *
	 * @example
	 * // Register provider with OAuth support
	 * yue.registerProvider("corporate-ai", {
	 ...
	 *
	 * @example
	 * yue.unregisterProvider("my-proxy");
	 */
...
/** Configuration for registering a provider via yue.registerProvider(). */
...
export type ExtensionFactory = (yue: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for yue.* API methods.
