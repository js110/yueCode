...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
	...
	const builtinCommandsSection = [
		...
		"",
		"The cli tool recognizes only the following Yue built-in commands and executes them internally (no shell fork):",
		"",
		...
		"  _workflow <action> [name]                     Main agent only: save, run, list, show, delete workflow DAGs",
		"",
		...
		"are missing from PATH, Yue injects temporary per-process shims for only those missing commands.",
		"",
		"Examples:",
