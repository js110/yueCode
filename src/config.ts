...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return "Download the latest Yue binary from the project releases page";
		case "pnpm":
...
export function getPackageDir(): string {
	...
	const envDir = process.env.YUE_PACKAGE_DIR;
	if (envDir) {
...
export function getBundledSkillsDir(): string {
	...
	// __dirname is always dist/src/ or src/ — builtin skills live at the same relative path from either
...
// =============================================================================
// App Config (from package.json yueConfig)
// =============================================================================

const pkg = JSON.parse(readFileSync(getPackageJsonPath(), "utf-8"));

const appConfig = pkg.yueConfig ?? {};

export const APP_NAME: string = appConfig.name || "yue";
export const CONFIG_DIR_NAME: string = appConfig.configDir || ".yue";
export const VERSION: string = pkg.version;

export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;

const DEFAULT_SHARE_VIEWER_URL = "https://yue.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.YUE_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.yue/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.yue/agent/) */
...
// =============================================================================
// Persistent (main) Agent Paths (~/.yue/main/*)
// =============================================================================
 ...
 * Default: ~/.yue/main. Overridable via --main-dir (passed as `override`).
 */
