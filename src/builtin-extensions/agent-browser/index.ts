 ...
 * native-Rust browser automation CLI — as a first-class capability of Yue.
 *
 * Design alignment with Yue:
 * - Yue exposes a single execution tool (`cli`). `agent-browser` stays a shell
...
export const createAgentBrowserExtension: ExtensionFactory = (yue: ExtensionAPI) => {
