...
const SHIM_ENV_KEY = "YUE_SHIM_DIR";

export function injectYuePathShims(env: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
	...
	const shimDir = mkdtempSync(join(tmpdir(), "yue-shims-"));
